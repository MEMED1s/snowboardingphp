      ...
      <div class="shop_top">
		<div class="container">
			<div class="col-md-6">
				...
				<div class="col-md-6" style="margin-left: 20%; border:3px";>
						...
						<form action="" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      ...
						      <input id="modlgn_username" type="text" name="emailname" class="inputbox" size="18" autocomplete="off" value="<?php if(isset($emailvalue)) echo $emailvalue ?>">
						    </p>
